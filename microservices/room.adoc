...
* *REGISTRATION_SECRET*:  A secret key shared between link:./concierge-adoc[Concierge] and services who are allowed to register rooms Room Service, and link:./room-nodejs.adoc[Room Node.js Service]). Set this value in concierge and then use it in other services.

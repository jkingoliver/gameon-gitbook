...
As a return parameter from Map operations, a `Site` contains an additional,
generated data describing the sites exits.

== The Nature of Doors

A door is a description, as seen from the outside of the room. The east door
(n) description should describe how a player traveling east will approach your
room.

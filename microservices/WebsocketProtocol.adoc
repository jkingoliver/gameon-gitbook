...
Note: "exits" and "commands" attributes can also be included with general room-sent events. This would allow you to change the description of doors or the text of commands based on room state, for example.

...
:toclevels: 2
:partOne: link:JSR-107caching.html
:prereqs: link:JSR-107caching.html#_prerequisites
:deps: link:JSR-107caching.html#_adding_the_dependencies
:mgr: link:JSR-107caching.html#_creating_the_default_cache_manager_provider
...
want to listen to, as each type has it's {listener}[own listener interface] to implement.
